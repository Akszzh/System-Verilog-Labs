module test_inheritance;
        ...
        class account_extd extends account_base;
                ...
                function int  summary_extd;
                        $display("the value of base class using super keyword is %d\n",super.balance);
        ...
        initial
                begin
                        ...
                        $display("the value of balance in base function is %d\n",acc_h.summary_base);


                        // Call method summary_extd to display balance

                        $display("the value of balance in extended class is %d",acc_h.summary_extd);
