module test_deep_copy;
        ...
        // Within initial
                ...
                // Display the properties of parent class and sub class properties of pkt_h1 and pkt_h2
                        ...
                        $display("the properties of parent class is %d %d %d\n",pkt_h1.header,pkt_h1.data,pkt_h1.pa.parity);
                        $display("the property of sub class is %d %d %d\n",pkt_h2.header,pkt_h2.data,pkt_h2.pa.parity);
